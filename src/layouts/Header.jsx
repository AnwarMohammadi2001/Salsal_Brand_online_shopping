...
export default function Header() {
  return (
    <header className="bg-white shadow-md px-4 md:px-10 py-4 flex items-center justify-between">
      {/* Shop Name */}
      <div className="text-2xl font-bold text-blue-600">Tamadon Shop</div>
