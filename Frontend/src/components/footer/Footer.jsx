          ...
          <div className="flex gap-4 items-center">
            <div className="w-full max-w-md mx-auto">
              ...
              <p className="text-sm text-gray-200 text-center mb-4">
                برای دریافت تازه‌ترین اخبار و محصولات ما، ایمیل خود را وارد
                کنید.
              </p>
              <div className="flex items-center  gap-x-2 overflow-hidden shadow-md">
                ...
                />
                <button className="px-5 py-2 bg-amber-500 hover:bg-amber-600 text-stone-900 font-semibold transition-all">
                  اشتراک
                </button>
              </div>
            </div>
